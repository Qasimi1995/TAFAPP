import 'package:chem/Pages/math_videos/math_videos_details.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';

import '../../localization/localization_constants.dart';
import '../Youtube/youtube_details.dart';

class Math_Video_Page extends StatefulWidget {
  final value;
  final LangData;
  const Math_Video_Page({Key? key,this.value, this.LangData}) : super(key: key);

  @override
  _Math_Video_PageState createState() => _Math_Video_PageState();
}

class _Math_Video_PageState extends State<Math_Video_Page> {
  ...
  _getVideos() async {
    ...
    Query q = await _Videos.collection("Videos_Math")
  ...
  _getMoreVideos() async {
    ...
    Query q = _Videos.collection("Videos_Math")
        .where("Video_Form", isEqualTo: widget.value)
        .where("Lang", isEqualTo: widget.LangData)
        .orderBy('order', descending: false)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            title:Text(getTranslated(context, 'math_video_list'))
          // !isSearching
              ...
              child: ListTile(
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => Math_Videos_Details(
